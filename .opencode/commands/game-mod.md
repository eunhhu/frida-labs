...
and verify one `defineInstrument()` declaration generating TUI controls (input,
checkbox, slider, select, and linked live state), RPC handlers, advanced-console
help, and persistent AI actions without parallel descriptor boilerplate. Also verify cleanup/reattach path, coverage report,
