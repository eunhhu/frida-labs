...
test("the generic probe descriptor inventory keeps its approved capability/effect contract", () => {
  const expectations: DescriptorExpectation[] = [
    ...
    ...entries("probe", ["instrument", "analysis"], "read", "table", ["protectionsScan"]),
    ...entries("probe", ["instrument"], "hook", "scalar", ["hookModuleLoad", "javaTraceClass"]),
    ...entries("probe", ["instrument", "analysis"], "hook", "scalar", ["javaWatchCrypto", "javaWatchWebViews", "javaWatchIntents"]),
    ...entries("probe", ["instrument", "analysis"], "read", "scalar", ["javaDumpPrefs"]),
